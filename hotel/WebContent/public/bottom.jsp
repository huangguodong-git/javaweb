...
<div id="StatusBar">
    ...
    <div id="StatusBar_Links">
		<a href="#" target="_blank">果冻餐厅</a>
    </div>
	<!-- 右侧功能按钮 -->
    <div id="StatusBar_Right">
		<!-- 版本 -->
		<a href="javascript:void(0)">
			<img border="0" width="11" height="11" src="${pageContext.request.contextPath }/images/sys/info.gif" /> 
			<img border="0" width="40" height="11" src="${pageContext.request.contextPath }/images/sys/version.gif" />
		</a>
    </div>
</div>
