...
#Head_1 {
    background: url("${pageContext.request.contextPath }/images/sys/img/top_head1_bg.gif") repeat-x scroll 0 0 transparent;
    height: 64px;
    margin: 0 auto;
    width: 100%;
}
...
#Head_2 {
   background: url("${pageContext.request.contextPath }/images/sys/img/top_head2_bg.gif") repeat-x scroll 0 0 transparent;
...
<body>
	...
	<div id="Head_1">
		<!-- 标题 -->
		<div id="Head_1_Logo">
			<b style="font-family: '黑体'">果冻餐厅</b>
        </div>
        
		<div id="Head_1_FunctionButton"> 
			<!-- <c:if test="${session_user.loginName == null}">
    ...
    <div id="Head_2">
		...
		<div class="Head2_FunctionList" style="float:left">
			<a href="javascript: window.parent.right.history.back();">
				<img src="${pageContext.request.contextPath }/images/sys/Header_back.gif" width="24" height="24" style="margin-top: -8px;"/>
				<b>后退</b>
			</a>
			<a href="javascript: window.parent.right.history.forward();">
				<img src="${pageContext.request.contextPath }/images/sys/Header_forward.gif" width="24" height="24" style="margin-top: -8px;"/>
				<b>前进</b>		
			</a>
        </div>
	</div>
